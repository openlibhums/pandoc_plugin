...
from plugins.pandoc import forms, plugin_settings, convert
...
def index(request):
    ...
    extract_images = setting_handler.get_setting(
        setting_group_name="plugin:pandoc",
        setting_name="pandoc_extract_images",
        journal=request.journal,
    ).processed_value
